...
![image-20220209152247426](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271921048.png)
...
![image-20220210095903409](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271922521.png)

##### 3.  模块、包、commonJS

​			![image-20220210100015768](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271922216.png)

###### 02 CommonJS规范

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271922868.png" alt="image-20220210101652166" style="zoom: 67%; float: left;" />

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271922002.png" alt="image-20220210101720533" style="zoom: 67%; float: left;" />
...
// 如果是 const parsedStr = url.parse(urlString, true)
// query: { id: '8', name: 'mouse' } 会被转换成对象
```
...
<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271922239.png" alt="image-20220213211406894" style="zoom:67%;" />

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271923077.png" alt="image-20220213211423142" style="zoom:67%;" />
...
在`fs`模块中，普通的fang发都是异步的，但是提供了一些同步方法为了方便使用。那我们到底是应该用异步方法还是同步方法呢？
...
![image-20220407085931744](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271923802.png)
...
可以开启 gzip 压缩，注意设置响应头 `Content-Encoding`

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271923877.png" alt="image-20220407105916114" style="zoom:50%;" />
...
<strong style="color:red;">使用多个回调函数</strong>处理路由（记得指定 next 对象）：
...
混合使用函数和函数数组处理路由：**可以给 res 挂载属性，进行数据传递**
...
<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271923076.png" alt="image-20220411104609389" style="zoom:50%;float:left" />
...
<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271923813.png" alt="image-20220411104652068" style="zoom:50%;float:left" />

##### **8.Express 生成器**

可以通过生成器直接生成开发模板

`npm install -g express-generator` 已安装

`express myapp -view==ejs` 生成指定模板为 ejs 的文件夹
...
<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271924106.png" alt="image-20220413085332378" style="zoom:67%;float:left" />

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271924985.png" alt="image-20220413090707891" style="zoom: 67%;float:left;" />

![image-20220413090406721](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271924485.png)



![image-20220413090614205](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271924145.png)
...
<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271924704.png" alt="image-20220413090814836" style="zoom:50%;float:left;" />

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271924535.png" alt="image-20220413090825381" style="zoom:50%;float:left" />

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271924211.png" alt="image-20220413090837613" style="zoom:50%;float:left" />

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271924008.png" alt="image-20220413090858199" style="zoom:50%;float:left" />

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271925614.png" alt="image-20220413090907539" style="zoom:50%;float:left" />

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271925637.png" alt="image-20220413090916971" style="zoom:50%;float:left" />

##### 5.可视化工具进行增删改查

Robomongo Robo3T adminMongo

![image-20220413091031852](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271925641.png)

##### 6.nodejs连接操作数据库

**注意 mongodb 和 mongoose 版本号必须匹配：https://blog.csdn.net/m0_62152730/article/details/124729238**
...
<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271925485.png" alt="image-20220414094020921" style="zoom: 67%; float: left;" />

<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271925912.png" alt="image-20220414094043782" style="zoom: 67%;float:left" />

##### 2.业务分层

![image-20220414094653807](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271925913.png)

#### 五、登录鉴权

##### 1. Cookie&Session

「HTTP 无状态」**我们知道，HTTP 是无状态的。也就是说，HTTP 请求方和响应方间无法维护状态，都是一次性的，它不知道前后的请求都发生了什么。但有的场景下，我们需要维护状态。最典型的，一个用户登陆微博，发布、关注、评论，都应是在登录后的用户状态下的。**「标记」那解决办法是什么呢？![image-20220414095345868](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271925112.png)
...
![image-20220415082822828](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271925704.png)

我为什么要保存这可恶的session呢， 只让每个客户端去保存该多好？

![image-20220415083015066](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271926162.png)
...
![image-20220415085343339](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271926182.png)
...
<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271926771.png" alt="image-20220417075653414" style="zoom:50%;" />
...
![image-20220417092053231](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271926846.png)
...
<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271927627.png" alt="image-20220417083817823" style="zoom:50%;float:left;" />

   ![image-20220417085913567](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271927581.png)
...
![image-20220417102845079](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271927631.png)
...
![image-20220420083146539](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271927714.png)
...
![image-20220420092527846](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271927524.png)
...
![image-20220420090841742](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271927693.png)
...
<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271927730.png" alt="image-20220421084242097" style="zoom:50%;" />
...
![image-20220505113605440](https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210271928719.png)
