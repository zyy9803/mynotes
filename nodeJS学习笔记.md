...
比如这个案例link了bootsrap，那么就需要读取public文件夹下的bootsrap.css文件，否则浏览器只发送请求，但找不到路径
...
<img src="https://candy-picture.oss-cn-hangzhou.aliyuncs.com/img/202210252230835.png" alt="image-20210427205402488" style="zoom:50%;" />
